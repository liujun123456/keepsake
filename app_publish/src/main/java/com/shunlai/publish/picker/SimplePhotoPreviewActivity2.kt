...
import kotlinx.android.synthetic.main.activity_img_preview_layout2.*
import java.io.File
 ...
 * @mobile 18711832023
 */
class SimplePhotoPreviewActivity2: BaseActivity() {
    override fun getMainContentResId(): Int=
        R.layout.activity_img_preview_layout2
    ...
    override fun afterView() {
        ...
        cl_layout.setOnClickListener { finish() }
    }
}
