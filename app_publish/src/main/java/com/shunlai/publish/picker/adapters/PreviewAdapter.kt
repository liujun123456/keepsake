 ...
 * @mobile 18711832023
 */
class PreviewAdapter(var mCtx:Context,var mDates:MutableList<Item>):RecyclerView.Adapter<PreviewAdapter.PreviewViewHolder>(){
    ...
    class PreviewViewHolder(var view:View):RecyclerView.ViewHolder(view){
        fun setData(item:Item){
            ImageUtil.showPreView(view.iv_preview,view.context,item.uri)
        }
    }
}
