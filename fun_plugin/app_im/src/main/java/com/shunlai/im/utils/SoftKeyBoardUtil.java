...
public class SoftKeyBoardUtil {
    ...
    private static SharedPreferences preferences = BaseApplication.mInstance.getSharedPreferences(Constant.UI_PARAMS, Context.MODE_PRIVATE);
    private static InputMethodManager imm = (InputMethodManager)  BaseApplication.mInstance.getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        ViewTreeObserver.OnGlobalLayoutListener listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (rootViewVisibleHeight - visibleHeight > 200) {
                    softKeyBoardHeight = rootViewVisibleHeight - visibleHeight - ScreenUtil.getNavigationBarHeight(BaseApplication.mInstance);
