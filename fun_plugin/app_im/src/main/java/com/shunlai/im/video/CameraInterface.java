...
import com.shunlai.common.utils.LogUtil;
import com.shunlai.im.utils.ScreenUtil;
import com.shunlai.im.video.listener.ErrorListener;
import com.shunlai.im.video.util.AngleUtil;
import com.shunlai.im.video.util.CameraParamUtil;
import com.shunlai.im.video.util.CheckPermission;
import com.shunlai.im.video.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private String saveVideoPath = FileUtil.getDefaultImagePath(BaseApplication.mInstance).getAbsolutePath();
...
//
        LogUtil.i(angle + " = " + cameraAngle + " = " + nowAngle);
    ...
    public void startRecord(Surface surface, float screenProp, ErrorCallback callback) {
        ...
        LogUtil.i( "setVideoSize    width = " + videoSize.width + "height = " + videoSize.height);
...
//        }
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.i("startRecord IllegalStateException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (IOException e) {
            e.printStackTrace();
            LogUtil.i("startRecord IOException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (RuntimeException e) {
            LogUtil.i( "startRecord RuntimeException");
        }
    }
