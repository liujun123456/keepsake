 ...
 * @mobile 18711832023
 */
class CorePostParamsObservable(private var life: LifecycleOwner?, private var paramUrl:String, private var paramMap:MutableMap<String,Any>, private var api: CoreRequestService): CoreObservable()  {
    override fun <T> subscribe(subscriber: CoreHttpSubscriber<T>) {
        val observable=buildObservable(api.postByMap(paramUrl,paramMap))
