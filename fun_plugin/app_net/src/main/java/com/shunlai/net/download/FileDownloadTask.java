...
package com.shunlai.net.download;

import android.os.AsyncTask;

import com.shunlai.net.util.FileUtils;
...
public class FileDownloadTask extends AsyncTask<Void, Long, Boolean> {
    ...
    public FileDownloadTask(String url, File target, FileDownloadCallback callback,OkHttpClient client) {
        this.url = url;
    ...
    protected void onProgressUpdate(Long... values) {
        ...
        if (callback != null && values != null && values.length >= 2) {
            ...
            callback.onFileProgress(progress, networkSpeed);
        }
    }
